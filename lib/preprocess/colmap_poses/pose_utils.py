...
from lib.preprocess.colmap_poses.colmap_wrapper import run_colmap
import lib.preprocess.colmap_poses.colmap_read_model as read_model
import argparse
...
def gen_poses(basedir, match_type, factors=None, colmap_camera_model='OPENCV'):
    ...
    if not all([f in files_had for f in files_needed]):
        ...
        run_colmap(basedir, match_type, colmap_camera_model)
    else:
